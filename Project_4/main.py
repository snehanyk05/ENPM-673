# -*- coding: utf-8 -*-
"""
Created on Mon Apr 15 17:45:52 2019
...
def LucasKanade(It, It1, rect, p0 = np.zeros(6)):
	# Input: 
	#	It: template image
	#	It1: Current image
...
inputFolder='data/car/'
rect=[(124, 104), (335, 272)]
It = cv2.imread(inputFolder+"frame0020.jpg", -1)
print(It.shape)
It1 = cv2.imread(inputFolder+"frame0021.jpg", -1)
